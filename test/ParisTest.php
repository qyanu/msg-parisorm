...
class ParisTest extends PHPUnit_Framework_TestCase {
    ...
    public function testCustomIDColumn() {
        ...
        $expected = "SELECT * FROM `custom_table` WHERE `custom_id_column` = ? LIMIT 1 {array (  0 => 5,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }

    public function testFilterWithNoArguments() {
        Model::factory('ModelWithFilters')->filter('name_is_fred')->find_many();
        $expected = "SELECT * FROM `model_with_filters` WHERE `name` = ? {array (  0 => 'Fred',)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }

    public function testFilterWithArguments() {
        Model::factory('ModelWithFilters')->filter('name_is', 'Bob')->find_many();
        $expected = "SELECT * FROM `model_with_filters` WHERE `name` = ? {array (  0 => 'Bob',)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHasOneRelation() {
        ...
        $expected = "SELECT * FROM `profile` WHERE `user_id` = ? LIMIT 1 {array (  0 => 1,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHasOneWithCustomForeignKeyName() {
        ...
        $expected = "SELECT * FROM `profile` WHERE `my_custom_fk_column` = ? LIMIT 1 {array (  0 => 1,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHasOneWithCustomForeignKeyNameInBaseAndAssociatedTables() {
        ...
        $expected = "SELECT * FROM `profile` WHERE `my_custom_fk_column` = ? LIMIT 1 {array (  0 => 'Fred',)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testBelongsToRelation() {
        ...
        $expected = "SELECT * FROM `user` WHERE `id` = ? LIMIT 1 {array (  0 => 1,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testBelongsToRelationWithCustomForeignKeyName() {
        ...
        $expected = "SELECT * FROM `user` WHERE `id` = ? LIMIT 1 {array (  0 => 5,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testBelongsToRelationWithCustomForeignKeyNameInBaseAndAssociatedTables() {
        ...
        $expected = "SELECT * FROM `user` WHERE `name` = ? LIMIT 1 {array (  0 => 'John Doe',)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHasManyRelation() {
        ...
        $expected = "SELECT * FROM `post` WHERE `user_three_id` = ? {array (  0 => 1,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHasManyRelationWithCustomForeignKeyName() {
        ...
        $expected = "SELECT * FROM `post` WHERE `my_custom_fk_column` = ? {array (  0 => 1,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHasManyRelationWithCustomForeignKeyNameInBaseAndAssociatedTables() {
        ...
        $expected = "SELECT * FROM `post` WHERE `my_custom_fk_column` = ? {array (  0 => 'Fred',)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHasManyThroughRelation() {
        ...
        $expected = "SELECT `author`.* FROM `author` JOIN `author_book` ON `author`.`id` = `author_book`.`author_id` WHERE `author_book`.`book_id` = ? {array (  0 => 1,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHasManyThroughRelationWithCustomIntermediateModelAndKeyNames() {
        ...
        $expected = "SELECT `author`.* FROM `author` JOIN `author_book` ON `author`.`id` = `author_book`.`custom_author_id` WHERE `author_book`.`custom_book_id` = ? {array (  0 => 1,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHasManyThroughRelationWithCustomIntermediateModelAndKeyNamesAndCustomForeignKeyInBaseAndAssociatedTables() {
        ...
        $expected = "SELECT `author`.* FROM `author` JOIN `author_book` ON `author`.`custom_author_id_in_author_table` = `author_book`.`custom_author_id` WHERE `author_book`.`custom_book_id` = ? {array (  0 => 49,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHasManyThroughRelationWithCustomIntermediateModelAndKeyNamesAndCustomForeignKeyInAssociatedTable() {
        ...
        $expected = "SELECT `author`.* FROM `author` JOIN `author_book` ON `author`.`custom_author_id_in_author_table` = `author_book`.`custom_author_id` WHERE `author_book`.`custom_book_id` = ? {array (  0 => 1,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
    ...
    public function testHasManyThroughRelationWithCustomIntermediateModelAndKeyNamesAndCustomForeignKeyInBaseTable() {
        ...
        $expected = "SELECT `author`.* FROM `author` JOIN `author_book` ON `author`.`id` = `author_book`.`custom_author_id` WHERE `author_book`.`custom_book_id` = ? {array (  0 => 49,)}";
        $this->assertEquals($expected, ORM::get_last_query());
    }
